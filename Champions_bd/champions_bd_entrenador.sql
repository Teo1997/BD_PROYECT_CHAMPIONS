...
CREATE TABLE `entrenador` (
  ...
  KEY `entrenador_equipo_idx` (`equipo_id`),
  CONSTRAINT `entrenador_equipo` FOREIGN KEY (`equipo_id`) REFERENCES `equipo` (`id_equipo`) ON DELETE NO ACTION ON UPDATE CASCADE
